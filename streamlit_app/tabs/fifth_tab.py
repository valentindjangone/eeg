...
def run():
    ...
    st.image(os.path.join(current_path, "../assets/tab_5/accuracy_evolution.png"))
    st.write("""
    ...
    st.image('assets/tab_5/normalized_confusion_matrix.png')      
    ...
    st.image(os.path.join(current_path, '../assets/tab_5/accuracy_gain.png'))
    st.write("""
             Notre système nous permet un boost de .1 sur les données de validation.
             """)
    st.image(os.path.join(current_path, '../assets/tab_5/kappa_coeff.png'))
