...
def run():
    ...
    st.image("assets/tab5/accuracy_evolution.png")
    st.write("""
    ...
    st.image('assets/tab5/normalized_confusion_matrix.png')      
    ...
    st.image('assets/tab5/accuracy_gain.png')
    st.write("""
             Notre système nous permet un boost de .1 sur les données de validation.
             """)
    st.image('assets/tab5/kappa_coeff.png')
