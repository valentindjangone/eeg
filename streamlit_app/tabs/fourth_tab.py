...
def run():
    ...
    st.title(title)
    tab_metho, tab_resultats = st.tabs(["Méthodologie", "Résultats"])
    with tab_metho:
        ...
        st.video("/Users/valentin/Desktop/eeg/streamlit_app/VotingClassifierAnimation.mp4")
    ...
    with tab_resultats:
        ...
        with col1:
            st.image("/Users/valentin/Desktop/eeg/streamlit_app/images/accuracy_evolution.png")

        with col2:
            st.image('/Users/valentin/Desktop/eeg/streamlit_app/images/normalized_confusion_matrix.png')       
        st.image('/Users/valentin/Desktop/eeg/streamlit_app/images/correct_incorrect.png')
        st.image('/Users/valentin/Desktop/eeg/streamlit_app/images/accuracy_gain.png')
        st.image('/Users/valentin/Desktop/eeg/streamlit_app/images/kappa_coeff.png')
